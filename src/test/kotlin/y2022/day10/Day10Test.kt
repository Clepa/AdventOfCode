...
class Day10Test {
  ...
  inner class Part1 {
    @Test
    fun `should the sum of 20, 60, 100, 140, 180, 220th signal strengths be 13140`() = assertEquals(13140, part1(input))
  }

  @Nested
  inner class Part2 {
    private val crtImage = """
      ##..##..##..##..##..##..##..##..##..##..
      ###...###...###...###...###...###...###.
      ####....####....####....####....####....
      #####.....#####.....#####.....#####.....
    ...
    @Test
    fun `should CRT produce desired image`() = assertEquals(crtImage, part2(input))
  }
}
